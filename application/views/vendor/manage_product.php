								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Product Management</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Product..." />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
													...
													<tr>
														...
														<td class="d-flex align-items-center">
															...
															<div class="d-flex flex-column">
																<a href="#" class="text-gray-800 text-hover-primary mb-1"><?=$key['name']?></a>
														...
														<td>
															<? if($key['available'] == '1'){ ?>
															<? $btnlabel = "Disable Product"; $labelColor = 'danger';?>
															<div class="badge badge-info fw-bold">Available</div>
															<? } else { ?>
															<? $btnlabel = "Reactive Product"; $labelColor = 'info'; ?>
															<div class="badge badge-danger fw-bold">Not Available</div>
															<? } ?>
