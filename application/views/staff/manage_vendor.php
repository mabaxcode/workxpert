										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-title">
												...
												<div class="d-flex align-items-center position-relative my-1">
													...
													<input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search staff" />
												</div>
												<!--end::Search-->
											</div>
											<!--begin::Card title-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="dt_staff_list">
												...
												<tbody class="text-gray-600 fw-semibold">
													<tr>
														...
														<td class="text-end">
															<a href="#" class="btn btn-light btn-info btn-flex btn-center btn-sm" data-kt-menu-placement="bottom-end">Top Up</a>
