								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Vendor Management</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="dt_staff_list">
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														...
														<td class="text-end">
															<a href="#" class="btn btn-light btn-info btn-flex btn-center btn-sm edit-vendor" data-kt-menu-placement="bottom-end" data-init="<?=$key['id']?>">Edit</a>
															<?/*
