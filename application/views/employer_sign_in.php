...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="<?=base_url('sign_in/register_employer')?>" method="post">
                <h3>Create Employer Account</h3>
                <span>Please fill up all the details</span>
        ...
        <div class="form-container sign-in-container">
            ...
            <form action="<?=base_url('sign_in/login_employer')?>" method="post">
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    ...
                    <button class="ghost" id="signUp">Create Employer Account</button>
                </div>
            </div>
        </div>
    </div>
