...
<base href="../" />
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="false" data-kt-app-aside-fixed="false" data-kt-app-aside-push-toolbar="false" data-kt-app-aside-push-footer="false" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
					...
					<div class="d-flex flex-stack flex-grow-1">
						<div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
							...
							<div id="kt_app_sidebar_toggle" class="app-sidebar-toggle btn btn-sm btn-icon bg-body btn-color-gray-500 btn-active-color-primary w-30px h-30px ms-n2 me-4 d-none d-lg-flex " data-kt-toggle="false" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
							...
							<!--begin::Logo-->
							<a href="<?=base_url('staff')?>"><i class="ki-outline ki-paypal fs-2hx mb-2 pe-0"></i></a>&nbsp;
						...
						<div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5"><?=$staffdata['name']?>
												<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?=$staffdata['staff_id']?></span></div>
												<a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?=$staffdata['email']?></a>
											</div>
											<!--end::Username-->
										</div>
									</div>
									...
									<div class="menu-item px-5">
										<a href="<?=base_url('staff/myProfile')?>" class="menu-link px-5">My Profile</a>
									</div>
									*/?>
									<!--end::Menu item-->
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href="<?=base_url('staff/logout')?>" class="menu-link px-5">Sign Out</a>
									</div>
									<!--end::Menu item-->
								</div>
							...
							<div class="app-navbar-item ms-2 ms-lg-6 me-lg-6">
								<!--begin::Link-->
								<a href="<?=base_url('staff/logout')?>" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					<!--begin::Sidebar-->
					<? $this->load->view('master-ui-staff/menu'); ?>
					<!--end::Sidebar-->
					<!--begin::Main-->
		...
		<!--end::Javascript-->
		<? $this->load->view('master-ui-staff/script'); ?>
	</body>
	<!--end::Body-->
</html>